...
@section('content-header')
    <h1>{{ $node->name }}<small>您的節點快速概覽。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li><a href="{{ route('admin.nodes.view.configuration', $node->id) }}">設定檔</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">刪除節點是不可逆轉的操作，將立即從面板中移除此節點。此節點必須沒有關聯的伺服器才能繼續。</p>
                    </div>
                    <div class="box-footer">
                        <form action="{{ route('admin.nodes.view.delete', $node->id) }}" method="POST">
                            {!! csrf_field() !!}
                            {!! method_field('DELETE') !!}
                            <button type="submit" class="btn btn-danger btn-sm pull-right" {{ ($node->servers_count < 1) ?: 'disabled' }}>是的，刪除此節點</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">此節點正在</span>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['memory']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">已分配記憶體</span>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-blue">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">總伺服器數</span>
