...
@section('content-header')
    <h1>{{ $node->name }}<small>控制此節點上可用於伺服器的配置。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.nodes.view.allocation', $node->id) }}">配置</a></li>
                        ...
                        <th>
                            <div class="btn-group hidden-xs">
                                <button type="button" id="mass_actions" class="btn btn-sm btn-default dropdown-toggle disabled"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">批次操作 <span class="caret"></span>
                                </button>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">在此輸入要分配連接埠的 IP 位址。</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">如果您想為這些配置分配預設別名，請在此輸入。</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">在此輸入單個連接埠或連接埠範圍，以逗號或空格分隔。</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">刪除 IP 區塊的配置</h4>
            </div>
            <form action="{{ route('admin.nodes.view.allocation.removeBlock', $node->id) }}" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger">刪除配置</button>
                </div>
            </form>
        </div>
    </div>
    ...
    function deleteSelected() {
        ...
        if (selectedItems.length !== 0) {
            ...
            if (selectedItems.length > 5) {
                formattedItems += '，以及其他 ' + (selectedItems.length - 5) + ' 個';
            }

            swal({
                type: 'warning',
                title: '',
                text: '您確定要刪除以下配置嗎：' + formattedItems + '？',
                html: true,
                showCancelButton: true,
