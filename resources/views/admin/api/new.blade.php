            ...
            <div class="col-sm-8 col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-default" id="btn-bulk-read">全部讀取</button>
                                <button type="button" class="btn btn-sm btn-default" id="btn-bulk-rw">全部讀取與寫入</button>
                                <button type="button" class="btn btn-sm btn-default" id="btn-bulk-none">全部取消</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <div class="radio radio-primary" style="margin: 0;">
                                            ...
                                            <label for="rw_{{ $resource }}">讀取和寫入</label>
                                        </div>
                                    </td>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">一旦您已分配權限並建立此憑證集，您將無法再回來編輯它。如果您需要在未來進行變更，您將需要建立新的憑證集。</p>
                    </div>
