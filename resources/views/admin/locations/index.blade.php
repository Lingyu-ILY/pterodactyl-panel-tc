...
@section('content-header')
    <h1>位置<small>可以將節點指定給所有位置，以便更輕鬆地分類。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">位置清單</h3>
                <div class="box-tools">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newLocationModal">建立新位置</button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="{{ route('admin.locations') }}" method="POST">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">建立位置</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="pShortModal" class="form-label">簡碼</label>
                            <input type="text" name="short" id="pShortModal" class="form-control" />
                            <p class="text-muted small">用於區分此位置與其他位置的簡短識別碼。必須介於 1 到 60 個字元之間，例如：<code>us.nyc.lvl3</code>。</p>
                        </div>
                        <div class="col-md-12">
                            <label for="pLongModal" class="form-label">描述</label>
                            <textarea name="long" id="pLongModal" class="form-control" rows="4"></textarea>
                            <p class="text-muted small">此位置的詳細描述。必須少於 191 個字元。</p>
                        </div>
                    </div>
                </div>
