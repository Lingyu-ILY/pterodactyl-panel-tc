        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_last" class="control-label">姓氏</label>
                        <div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>此使用者在面板中顯示時所使用的預設語言。</small></p>
                        </div>
                    </div>
                </div>
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="submit" value="建立使用者" class="btn btn-success btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>將此選項設為「是」會賦予使用者完整的管理員權限。</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>設定使用者密碼為選填。新使用者在首次登入時，系統會透過電子郵件提示使用者建立密碼。若在此提供密碼，你需要以其他方式將密碼提供給該使用者。</p>
                    </div>
    ...
    <script>$("#gen_pass_bttn").click(function (event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#gen_pass").html('<strong>產生的密碼：</strong> ' + data).slideDown();
